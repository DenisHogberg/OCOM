...
| 0.2 | 7 сентября 2026 | Редакционная правка без смены версии: формулировка приведена в соответствие с опубликованной версией, Identity названа первым понятием, а не объектом. |
| 0.2 | 17 сентября 2026 | Поле «Обновлено» приведено в соответствие с последней строкой этой таблицы (7 сентября 2026); содержание не менялось. |
