...
**Recorded against:** model `066a4ba34e504aee`, map `bb6d9b8f2e25090e`, statement `cf478add0bddcc36`, register `e09cdd67d62d7951`, alias file `44fcbf6a2466d9fe`, catalogue `deda54f26db781a0` (the first sixteen hex digits of each file's SHA-256, as `tools/conformance/validate.py` prints them). The tool refuses this record against any other export: a judgment recorded against one model is a judgment about that model.
