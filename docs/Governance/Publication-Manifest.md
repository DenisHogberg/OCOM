...
| **Commit** | `73d73b95e10ebc808554985afe89466316273f45` |
| **Constitution Version** | 1.0.1 |
...
| **Specification Version** | 1.0 |
| **Publication Date** | Published 2026-09-22T15:48:25Z (GitHub Release timestamp); Zenodo record published 2026-09-22T15:48:29Z, minted by the GitHub integration on the release event without intervention. |
| **Published Artifacts** | GitHub Release "OCOM v1.4.0: Object-Centric Operating Model, an open specification for a machine-readable description of an organization" from an SSH-signed annotated tag `v1.4.0` with the three assets `Release-Workflow.md` step 7 names (`OCOM-v1.4.0.zip`, `SHA256SUMS`, `SHA256SUMS.sig`), verified from the public download on publication day; Zenodo version DOI `10.5281/zenodo.22900969` (`doi.org/10.5281/zenodo.22900969`), under the concept DOI `10.5281/zenodo.21510450`, resource type Standard, the Release body as the record description. |
...
| 0.1 | 22 September 2026 | `v1.4.0` entry completed after publication: Commit `73d73b9` (the merge commit of the carrying pull request, per `Release-Workflow.md` step 6), GitHub Release timestamp 2026-09-22T15:48:25Z, Zenodo version DOI `10.5281/zenodo.22900969` (record published 2026-09-22T15:48:29Z), assets verified from the public download. |
