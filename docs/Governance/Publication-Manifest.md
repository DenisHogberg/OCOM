...
| **Core Vocabulary Version** | 0.1 (13 governed terms) |
| **Specification Version** | 0.2 |
| **Publication Date** | Published 2026-09-16T18:04:46Z (GitHub Release timestamp). Zenodo: the GitHub webhook to Zenodo answered 500 on every release event on publication day (a Zenodo outage), so no deposit exists yet; the version DOI is added once the delivery is repeated and the record published. |
