...
- The Specification/implementation-behavior boundary (Architecture Principles 1, 3, 7) should have been tested and drawn on day one, not discovered until the Agents/Reader boundary was examined, roughly five months into development. A meaningful share of `AI/Prompts/`, `AI/Tools/`, `AI/Evaluation/` was very likely written assuming Specification and product were the same thing, before that assumption was ever examined.
