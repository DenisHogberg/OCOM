...
- [Architecture Observations](docs/Governance/Architecture-Observations.md): 94 recorded tensions, AO-001 to AO-095 with 072 reserved, including the ones the specification's own site found when it audited itself and the ones its own logic check found.
